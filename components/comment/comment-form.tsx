    ...
    <form action={action} className="mb-8">
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          ...
          {'body' in formState.errors && (<p className="text-red-600 text-sm font-medium">{formState.errors.body}</p>)}
          ...
          {
           'formErrors' in formState.errors&& <div className="p-2 border border-red-600 bg-red-100 ">{formState.errors.formErrors[0]}</div>
          }
        </div>
      </div>
    </form>
